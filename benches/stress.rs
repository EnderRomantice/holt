...
fn print_holt_shape(label: &str, tree: &Tree) {
    ...
    println!(
        ...
        s.bm_cold_token_count,
        s.bm_cold_index_cache_entries,
        s.bm_cold_index_cache_bytes,
        s.bm_cold_index_cache_budget_bytes,
        s.bm_cold_page_cache_entries,
        s.bm_cold_page_cache_bytes,
        s.bm_cold_page_cache_ghost_entries,
        s.bm_cold_page_cache_budget_bytes,
        s.bm_cold_page_hits,
        ...
        s.store.cold_index_file_bytes,
        s.store.cold_index_high_water_bytes,
        s.store.cold_value_file_bytes,
        s.store.cold_value_high_water_bytes,
