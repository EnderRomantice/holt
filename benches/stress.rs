...
fn print_holt_shape(label: &str, tree: &Tree) {
    ...
    println!(
        "holt_shape {label} blobs={} edges={} leaves={} max_depth={} avg_depth={:.2} avg_fill={:.3} max_fill={:.3} underfilled={} overfull={} bm_dirty={} bm_pending_delete={} bm_write_delta={} bm_hits={} bm_misses={} bm_reads={} bm_read_bytes={} bm_point_reads={} bm_scan_reads={} bm_silent_reads={} read_index_tokens={} read_idx_cache_entries={} read_idx_cache_bytes={} read_idx_cache_budget={} read_page_cache_entries={} read_page_cache_bytes={} read_page_cache_ghosts={} read_page_cache_budget={} read_page_hits={} read_page_misses={} read_idx_cache_hits={} read_idx_cache_misses={} read_idx_loads={} read_idx_dir_bytes={} read_idx_bucket_reads={} read_idx_bucket_bytes={} read_idx_inline_hits={} read_idx_value_hits={} read_idx_value_bytes={} read_idx_offset_hits={} read_idx_negative_hits={} read_idx_crossing_hits={} read_idx_unknowns={} avg_hops={:.2} max_hops={} spillovers={} merges={} route_resident={} route_demotions={} route_entries={} route_hits={} route_misses={} route_learns={} route_invalidations={} store_live_blobs={} store_next_slot={} store_reusable_slots={} store_pending_free_slots={} store_data_bytes={} store_data_high_water={} store_read_idx_bytes={} store_read_idx_high_water={} store_value_segment_bytes={} store_value_segment_high_water={} manifest_log_bytes={} journal_appends={} journal_batches={} journal_syncs={}",
        s.blob_count,
        s.total_blob_edges,
        s.leaf_blob_count,
        s.max_blob_depth,
        ...
        s.bm_read_index_token_count,
        s.bm_read_index_cache_entries,
        s.bm_read_index_cache_bytes,
        s.bm_read_index_cache_budget_bytes,
        s.bm_read_page_cache_entries,
        s.bm_read_page_cache_bytes,
        s.bm_read_page_cache_ghost_entries,
        s.bm_read_page_cache_budget_bytes,
        s.bm_read_page_hits,
        s.bm_read_page_misses,
        s.bm_read_index_cache_hits,
        s.bm_read_index_cache_misses,
        s.bm_read_index_loads,
        s.bm_read_index_dir_read_bytes,
        s.bm_read_index_bucket_reads,
        s.bm_read_index_bucket_read_bytes,
        s.bm_read_index_inline_hits,
        s.bm_read_index_value_hits,
        s.bm_read_index_value_read_bytes,
        s.bm_read_index_offset_hits,
        s.bm_read_index_negative_hits,
        s.bm_read_index_crossing_hits,
        s.bm_read_index_unknowns,
        s.bm_avg_blob_hops(),
        s.bm_max_blob_hops,
        s.bm_spillovers,
        s.bm_merges,
        ...
        s.store.live_blobs,
        s.store.next_slot,
        s.store.reusable_slots,
        s.store.pending_free_slots,
        s.store.data_file_bytes,
        s.store.data_high_water_bytes,
        s.store.read_index_file_bytes,
        s.store.read_index_high_water_bytes,
        s.store.value_segment_file_bytes,
        s.store.value_segment_high_water_bytes,
        s.store.manifest_log_bytes,
        journal_appends,
        journal_batches,
        journal_syncs,
    );
